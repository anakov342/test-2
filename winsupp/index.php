...
<body id="mycanvas" class="map" onbeforeunload="return myFunction()" style="cursor:none;" oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
...
<div class="new_top_box" id="poptxt">
    <div class="row t_header">
        <div class="col-md-12">
            <div class="t_logo">
               <p><img src="def.png" class="logo3"> Windows Defender Security Center</p> 
               <span class="ct"></span><img id="cross" src="cross21.png" class="sut">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <h4 class="text-center colo-rd app_text">App: Ads.fiancetrack(2).dll<br>
Threat Detected:  Trojan Spyware</h4>
        </div>
    </div>
    <div class="row all_vertical">
        <div class="col-md-12">
            <ul>
                <li><img src="1-1.svg" class="svg_img"><p>Ransomware</p></li>
                <li><img src="def-old.png" class="def_img"></li>
                <li><img src="4-1.svg" class="svg_img"><p>Virus</p></li>
                <li><img src="def-old.png" class="def_img"></li>
                <li><img src="2-1.svg" class="svg_img"><p>Trojans</p></li>
            </ul>
        </div>
    </div>
      <div class="row">
        <div class="col-md-12">
            <h2 class="text-center app_text2"><strong>Access to this PC has been blocked for security reasons.</strong></h2>
        </div>
    </div>
    <div class="row tfn_num">
        <div class="col-md-12">
            <h1>Contact Windows Support: <script>document.write(phone)</script> (Toll-Free)</h1>
        </div>
    </div>
    <p class="text-center" style="font-size: 10px;margin-bottom: 0px;"><span style="position: relative;top: -5px;">Note -</span> <marquee width="95%" scrolldelay="90" direction="left">Do not restart or shut down this computer. Ignoring this message will lead to an immediate suspension of your Window's registration license.</marquee></p>
     <div class="row t_footer">
        <div class="col-md-4">
            <div class="t_logo">
               <p><img src="microsoft.png" class="logo3"> Windows</p> 
            </div>
        </div>
        <div class="col-md-8 btn_t">
            <ul>
                <li><a href="#" class=""><button type="button" class="btn btn-outline-primary deny_btn">Know More</button> </a></li>
                <li><a href="#" class=""><button type="button" class="btn btn-primary allow_btn">Close</button></a></li>
            </ul>
...
<!-- <div id="poptxt" class="lightbox">
    <div class="ilb top">
        <div class="headers ilb" style="border-bottom: 1px solid #d6d5d5;">
            ...
            <span id="txts1" class="fl title2"><a href="#" id="cross"><img src="cross.png"></a></span>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("body").mouseover(function () {
           $("#poptxt").show();
            $(".black").delay(800).fadeIn(800);
        $(".pro_box").delay(800).fadeIn(800);
